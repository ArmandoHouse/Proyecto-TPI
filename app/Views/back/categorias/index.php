...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if (isset($inactivas) && $inactivas): ?>
            <a href="<?= base_url('admin/categorias') ?>" class="btn btn-secondary">Ver Activas</a>
        <?php else: ?>
            <a href="<?= base_url('admin/categorias/inactivas') ?>" class="btn btn-secondary">Ver Inactivas</a>
        <?php endif; ?>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                ...
                                <form action="<?= base_url('admin/categorias/eliminar/' . $categoria['id']) ?>" method="post" onsubmit="return confirm('¿Seguro que querés eliminar esta categoría?');" style="display:inline;">
                                    <?= csrf_field() ?>
