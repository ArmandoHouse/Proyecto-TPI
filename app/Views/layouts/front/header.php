...
<div class="sticky-top">
  ...
  $categorias = $categoriaModel->getDisponibles();
    ...
    <div class="container">
      <div class="collapse navbar-collapse justify-content-center" id="navbarNavDropdown">
        <ul class="navbar-nav">
                  ...
                  <?php foreach ($chunks as $columna) : ?>
                    <div class="col-12 col-md-3">
                      <?php foreach ($columna as $categoria) : ?>
                        <a class="dropdown-item" href="<?= base_url('catalogo/ver_catalogo/' . $categoria['id']) ?>">
          ...
          <li class="nav-item mx-2">
            <a class="nav-link" href="<?= base_url('contacto') ?>">Información de Contacto</a>
          </li>
          <li class="nav-item mx-2">
