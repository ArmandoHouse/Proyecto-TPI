...
return [
    ...
    'field_exists'          => 'El campo debe existir.',
    ...
    'valid_url_strict'      => 'El campo debe contener una URL válida.',
    'valid_date'            => 'El campo debe contener una fecha válida.',
    'valid_json'            => 'El campo debe contener un json válido.', // 'The field must contain a valid json.',
    ...
    'min_dims' => 'no es una imagen, o no es lo suficientemente ancha o alta.', // 'is either not an image, or it is not wide or tall enough.',
];
